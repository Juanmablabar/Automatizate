...
public class Test3 {
	...
	public void testCase() throws Exception {
		...
		// loop that goes through the list and through the if it extracts the first and
		// last news
		for (WebElement element : list) {
			if (element.getAttribute("cmp-ltrk-idx").equals("0")
					|| element.getAttribute("cmp-ltrk-idx").equals(list.size() - 1 + "")) {
